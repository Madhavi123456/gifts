                            ...
                            <form:form action="${cat}" method="post" commandName = "category">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <form:input type="text" class="form-control" id="first_name" value="" path="CatId" placeholder="cat id" required="required"/>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <form:input type="text" class="form-control" id="last-name" value="" path="CatName" placeholder="cat name" required="required"/>
                                    </div>
                    ...
                    <div class="col-2 col-lg-12">
                        <div class="cart-summary">
                            ...
                            <ul class="summary-table">
                                <li><span><u>catId:</u></span> <span><u>catName</u></span>  <span><u>Actions</u></span></li>
                                <c1:forEach items="${Categories}" var="cat">
                                <li><span>${cat.getCatId()} </span>  <span>${cat.getCatName()}</span> 
                                
                               <span> <a href="<c:url value="/editCategory/${cat.getCatId()}"/>"> Edit</a>/<a href="<c:url value="/deleteCategory/${cat.getCatId()}"/>">Delete</a>
	 								</span>
                                </c1:forEach>
                            </ul>
