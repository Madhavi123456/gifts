                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <c:url value="/addUsers" var="users"/>
                            <form:form action="${users}"  method="post" commandName ="users">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                     <form:input type="text" class="form-control" path="Name" placeholder="user Name"/>
                                    
                             <%-- <form:input path="Name" type="text" class="form-control" id="first_name"  placeholder="user Name"  required/> --%>
                          
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    <form:input path="Id" type="text" class="form-control" placeholder="user id" />
                                    </div>
                                    <div class="col-12 mb-3">
                                    <form:input type="text" class="form-control" path="Adddress" placeholder="user address"/>
                                      <%--  <form:input type="text" class="form-control" id="email" placeholder="user address" value="" required> --%>
                                    </div>
                                    
                                    <div class="col-12 mb-3">
                                     <form:input  type="text" class="form-control" path="PhoneNo" placeholder="user phoneno" />
                                     <%--      <form:input type="text" class="form-control mb-3" id="street_address" placeholder="user phoneno" value="" required/> --%>
                                    </div>
                                    <div class="col-12 mb-3">
                                      <form:input  type="text" class="form-control" path="Password" placeholder="user password"/>
                                       <%--    <form:input type="text" class="form-control" id="city" placeholder="user password" value="" required/> --%>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                     <form:input  type="email" class="form-control" path="EmailId" placeholder="user email" />
                                       <%--    <form:input type="text" class="form-control" id="zipCode" placeholder="user email" value="" required/> --%>
                                    </div>
